class Car 
{
  #brand;
  #model;
  speed = 0; //Default value, can also be set in the constructor as this.speed=0;
  isTrunkOpen = false;
...
car1.go();
car1.brake();
car1.displayInfo();  //to update speed we call again
...
car2.brake();
car2.brake();
car2.displayInfo();  //to update speed we call again
